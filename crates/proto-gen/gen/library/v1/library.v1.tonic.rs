...
pub mod library_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("library.v1.LibraryService", "GetHealth"));
...
pub mod library_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/library.v1.LibraryService/GetHealth" => {
                    ...
                    struct GetHealthSvc<T: LibraryService>(pub Arc<T>);
                    impl<
                        T: LibraryService,
                    ...
                    for GetHealthSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as LibraryService>::get_health(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "library.v1.LibraryService";
