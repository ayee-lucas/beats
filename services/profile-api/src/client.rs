...
use http::Uri;
use proto_gen::connect::profile::v1::ProfileServiceClient;
use proto_gen::proto::profile::v1::GetHealthRequest;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let profile_client = ProfileServiceClient::new(http, config);
